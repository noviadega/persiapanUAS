...
<body class="hold-transition skin-blue layout-top-nav">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-primary navbar-laravel shadow  ">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <!-- carts -->
                            <li class="nav-item">
                                <a href="{{ route('carts.index') }}" class="nav-link dropdown-toggle">
                        ...
                        <!-- carts -->
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" aria-hidden="true" href="#" id="navbarDropdown"
